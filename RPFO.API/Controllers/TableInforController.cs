...
namespace RPFO.API.Controllers
{
    ...
    public class TableInforController : ControllerBase    
    {
        ...
        ITableInforService _tableService;
        private readonly ILogger<TableInforController> _logger;

        public TableInforController(ILogger<TableInforController> logger, ITableInforService tableService)
        {
            _logger = logger;
        ...
        {
            return await _tableService.GetAll(CompanyCode, StoreId, Keyword);
        }
        ...
        {
            return await _tableService.GetByCode(CompanyCode, StoreId, TableId);
        }
        ...
        {
            return await _tableService.Import(models);
        }
    }
}
